    ...
    public function processar(array $message): void
    {
        ...
        if ($tecnico === null) {
            $this->telegram->sendMessage(
                $chatId,
                "Voce nao esta cadastrado como tecnico neste sistema. Fale com o administrador para ser cadastrado."
            );
            return;
        }
        ...
        match ($comando) {
            ...
            '/start'        => $this->comandoStart($chatId, $tecnico),
            default         => null,
        };
    }

    private function comandoStart(int|string $chatId, array $tecnico): void
    {
        $this->telegram->sendMessage(
            $chatId,
            "Ola, {$tecnico['nome']}!\n\n" .
