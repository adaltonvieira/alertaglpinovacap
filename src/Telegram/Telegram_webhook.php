...
/**
 * Endpoint publico que recebe os updates do Telegram (cliques nos botoes
 * Assumir, Confirmar leitura, Ver SLA).
 *
 * Precisa estar registrado como webhook do bot (ver
 * scripts/register_telegram_webhook.php) e exige HTTPS publico - so
 * funciona de verdade depois que o dominio (Railway ou a VM da NOVACAP)
 * estiver acessivel.
 */
...
// Valida o segredo do webhook (protege contra chamadas falsas de terceiros)
...
try {
    ...
    // Nunca deixa o Telegram ver erro 500 puro - registra e responde 200
    // mesmo assim, senao o Telegram fica reenviando o mesmo update.
